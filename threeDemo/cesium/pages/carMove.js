 ...
 * @Last Modified time: 2019-09-12 02:50:11
...
var pageOper = {
  ...
  carMove: function() {
    ...
    carEntity.availability = new Cesium.TimeIntervalCollection([
...
var pageInit = {
  ...
  initVisualBlock: function() {
    ...
    var height = Math.ceil(viewer.camera.positionCartographic.height).toFixed(
      3
    );
  ...
  initGisEvent: function() {
    ...
    handler.setInputAction(function(movement) {
      ...
      if (cartesian) {
        ...
        console.log(
          "点击点位:" + longitudeString + ", " + latitudeString + "," + height
        );
      }
